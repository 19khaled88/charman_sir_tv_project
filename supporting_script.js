    ...
    dateTimeElement.innerHTML = `
        ...
        <div class="clock_section" id="clock_section">
            <svg id='clock' viewBox='0 36 122 36' xmlns='http://www.w3.org/2000/svg'>
                <g id='seconds'>
                <g>
                    <path id='f7' d='M106,69l3-3h6l3,3c0,0-1,1-3,1h-6C107,70,106,69,106,69z' fill=''/>
                    <path id='f6' d='M119,55l-3,2v8l3,3c0,0,1-1,1-3v-7C120,56,119,55,119,55z' fill=''/>
                    <path id='f5' d='M105,55l3,2v8l-3,3c0,0-1-1-1-3v-7C104,56,105,55,105,55z' fill=''/>
                    <polygon id='f4' points='109,52 115,52 118,54 115,56 109,56 106,54' fill=''/>
                    <path id='f3' d='M119,40l-3,3v8l3,2c0,0,1-1,1-3v-7C120,41,119,40,119,40z' fill=''/>
                    <path id='f2' d='M105,40l3,3v8l-3,2c0,0-1-1-1-3v-7C104,41,105,40,105,40z' fill=''/>
                    <path id='f1' d='M106,39l3,3h6l3-3c0,0-1-1-3-1h-6C107,38,106,39,106,39z' fill=''/>
                </g>
                <g>
